            ...
            <div className='col-md-6 offset-md-3 border-dark rounded p-4 mt-2 shadow'>
                ...
                <div className="row mb-4">
                   ...
                   <div className="col-sm-7">
                     <input type="email" className="form-control border-dark" id="Number" placeholder=""/>
                   </div>
                </div>
                <div className="row mb-3">
                   <label for="pin" className="col-sm-4 col-form-label"><b>PIN:</b></label>
                   <div className="col-sm-7">
                     <input type="password" className="form-control border-dark" id="pin" placeholder=""/>
                   </div>
                </div> <br/>
                <div class="d-grid gap-2 d-md-block">
                    <button type="submit" className="btn btn-outline-dark">Sign In</button>
                    <button type="submit" className="btn btn-outline-dark mx-2 "> Cancel </button>
                </div><br></br>
